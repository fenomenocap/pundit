...
The legacy Vercel project **`football_prediction_market`** (Kickpredict UI on `football-prediction-markets.vercel.app`) should be **disconnected** from this repo — it is not Pundit and causes a failing GitHub commit check on every push.
