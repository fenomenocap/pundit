...
**Today**, that's a multi-turn chat backed by a Dixon-Coles club fixture model (ClubElo + home-field advantage), ESPN standings, a Premier League season simulator, and reference Stake/Kalshi/Polymarket prices — all read-only, informational, nothing to trade. Credibility is shown openly through rolling club-season calibration and a frozen World Cup 2026 backtest.
